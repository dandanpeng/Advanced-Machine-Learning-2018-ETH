...
# -*- coding: utf-8 -*
"""
Created on Thu Nov 15 14:59:17 2018
...
x_train = readts('X_train.csv')
y_train = pd.read_csv('Y_train.csv')
x_test = readts('X_test.csv')
...
def process(dataset,fs): #Remember; hrw was the one-sided window size (we used 0.75) and fs was the sample rate (file is recorded at 100Hz)
    calc_RR(dataset, fs)
    #calc_ts_measures()
...
xtrain,xtest,labels,y_test = train_test_split(train_features.iloc[:,1:],y_train['y'],test_size = 0.1,random_state =0)
